...
/* Function to gerneate the calendar table */
...
/* Functoon write a table row of weekday abbreviations */
...
function calDays(calDate) {
    ...
    // Write the blank cells preceding the starting day
    var htmlCode = "<tr>";
    ...
    for(var i = 1; i<=totalDays; i++) {
        ...
        weekDay = day.getDay();
        if(i === highlightDay) {
            htmlCode += "<td class='calendar_today'>" + i + dayEvent[i] + "</td>";
        }
        else {
